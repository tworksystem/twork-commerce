...
1. **Real-time Sync**: Points sync automatically when app goes online
2. **Offline Support**: Points are cached locally for offline viewing
3. **Transaction History**: Full history with pagination
4. **Balance Display**: Current balance shown in profile
